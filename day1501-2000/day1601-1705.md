...
I studied with more dive how works the useEffect React JS hook, also I studied a little how ReactJs manage the status update in the application.
...
I continue studying more about Frontend technologies, I am doing a NextJS tutorial to learn the recent frontend technologies, In the past I learned and created interesting React JS applications, with MERN stack, I want to learn how to use ReactJs 18 and NextJS to build some basic applications, for the moment I am in the bom moment, when you start to remember a technology learned on the past.
