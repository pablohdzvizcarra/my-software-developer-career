...
Today I created an AWS integration using EventBridge and Lambda AWS services. I configured EventBridge as a cronjob to trigger a Lambda function, the lambda function only makes an HTTP request to an external API to extract information. Also I configured EventBridge to catch the event when a user upload a file to a S3 bucket and then send a email notification with SNS.
...
I reviewed the better solutions to the problem, but for me these solutions were hard to understand, they used a lot of math in the solution.
...
Today I continued studying about Cloud computing and solving some LeetCode question about Greedy algorithms.
...
This course is amazing because first the teacher presents the problem, second explain the problem with simple words, also suggests the pattern to solve the problem and finally show the code solution.
...
During the weekend I completed the book A Common Sense guide to DSA and algorithms, I am writing my book review in a Medium blog post. I am very happy to complete the book, I learned a lot things about DSA and algorithms and well I feel my Software Engineer skills are improving. The next step is continue studying these topics practicing with algorithms problems in LeetCode and GeekForGeeks.
