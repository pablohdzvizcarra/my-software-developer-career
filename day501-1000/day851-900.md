...
The actual problem is you have a Cron tasks that executes each minute, but you have ten instances of this program yes now you have ten Cron tasks that executes each minutes, solution a unique instance of this program or use a queue, Kubernetes  I love it but with your auto scaling I have problems.

##### Day 898 Kotlin And Kotlin

Today I was writing code with Kotlin language, whoa Kotlin is beautiful, and also I start reading a new book my next book is Grit, I know this book is not about programming but it's interesting.
