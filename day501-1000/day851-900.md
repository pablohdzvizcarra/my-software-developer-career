...
The actual problem is you have a Cron tasks that executes each minute, but you have ten instances of this program yes now you have ten Cron tasks thats executes each minutes, solution a unique instance of this program or use a queue, Kubernetes  I love it but with your auto scaling I have problems.

##### Day 898 Kotlin And Kotlin

Today I was writing code with Kotlin language, Woa Kotlin is beautiful, and also I start reading a new book my next book is Grit, I know this book is not about programming but it's interesting.

##### Day 897 Working a lot

This days I am working a lot, more than 12 hours dailies I am tired, but I learn a lot of things.
...
Today I study about the strategy pattern I build a basic API  to buy books in a e commerce app, well it's not finished yet, but tomorrow finish with this app.
...
In this days all things are Async, the company number one in Microservices called Netflix contribute a lot to the community,  in my work we use Microservices architecture each day I lean more things about this topic
...
that line, it is a difficult situation, but I really like the feeling of having to solve a problem
