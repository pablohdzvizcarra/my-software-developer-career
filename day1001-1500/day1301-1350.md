...
it's curious about how Java called the Dataframe, I feel a little sick, I hate when I have a cold, programming is
complicated with a cold.

#### Day 1331 Union Dataframe

Today I did a union with two Dataframe also I learned how to modify the name of the columns and how to add more
columns in a dataframe, and fill the values in these columns.
Manipulates Dataframe with Spark sometimes can be a little tedious because you need to ensure that the type of the
